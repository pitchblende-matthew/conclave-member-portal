    ...
    <>
      ...
      >
        ...
        <div className={`nav-group${menu === "community" ? " open" : ""}`}>
          <button
            type="button"
            className={`nav-link nav-group-btn${groupActive(["/board", "/requests", "/events", "/briefings", "/jobs", "/businesses"]) ? " active" : ""}`}
          ...
          <div className="nav-dropdown">
            ...
            <Link href="/requests" className="nav-drop-link" onClick={close}><Icon name="connections" size={16} />Asks &amp; Offers</Link>
            ...
            <Link href="/jobs" className="nav-drop-link" onClick={close}><Icon name="briefcase" size={16} />Jobs</Link>
            <Link href="/businesses" className="nav-drop-link" onClick={close}><Icon name="store" size={16} />Businesses for sale</Link>
          </div>
        </div>
        ...
        <div className={`nav-group${menu === "network" ? " open" : ""}`}>
          <button
            type="button"
            className={`nav-link nav-group-btn${groupActive(["/directory", "/discover", "/functions", "/companies", "/industries", "/connections", "/messages"]) ? " active" : ""}`}
          ...
          <div className="nav-dropdown">
            ...
            <Link href="/discover" className="nav-drop-link" onClick={close}><Icon name="connections" size={16} />Discover</Link>
