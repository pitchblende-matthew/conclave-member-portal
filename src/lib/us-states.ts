// Client-safe list of US states (50 + DC). No server imports, so this can be
// pulled into client form components. lib/region.ts re-exports it for servers.
...
export const STATE_ABBRS = new Set(US_STATES.map((s) => s.abbr));
